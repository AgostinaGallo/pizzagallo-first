...
role="dialog" tabindex="-1" id="modal-delete-{{$ing->idingreso}}"> {{-- El id de este modal hace referencia a una PERSONA especifica--}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Confirme si desea cancelar este Ingreso Almacén</p>
                </div>
