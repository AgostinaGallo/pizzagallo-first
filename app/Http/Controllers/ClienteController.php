...
class ClienteController extends Controller
{
    ...
    public function index(Request $request)
    {
			...
			
        {
            ...
            ->where ('tipo_persona','=','Cliente') //condicion donde 'condicion'  sea 'Cliente'
            ...
            ->where ('tipo_persona','=','Cliente') // y ademas la persona sea cliente
    ...
    {   
		...
		$persona=new Persona;
        $persona->tipo_persona='Cliente'; // cuando el formulario envie datos, el tipo de persona sera Cliente
