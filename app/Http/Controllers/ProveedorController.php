...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request)
    {
			...
			
        {
            ...
            ->where ('tipo_persona','=','Proveedor') //condicion donde 'condicion'  sea 'Cliente'
            ...
            ->where ('tipo_persona','=','Proveedor') // y ademas la persona sea cliente
    ...
    {   
		...
		$persona=new Persona;
        $persona->tipo_persona='Proveedor'; // cuando el formulario envie datos, el tipo de persona sera Cliente
